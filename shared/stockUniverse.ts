/**
 * Stock Universe - S&P 500 Companies and Top ETFs
 */
...
export const SP500_STOCKS: Security[] = [
  ...
  { ticker: 'CTRA', name: 'Coterra', sector: 'Energy' },
  ...
  { ticker: 'DAY', name: 'Dayforce', sector: 'Industrials' },
  ...
  { ticker: 'IPG', name: 'Interpublic Group of Companies (The)', sector: 'Communication Services' },
  ...
  { ticker: 'PAYC', name: 'Paycom', sector: 'Industrials' },
...
export const TOP_ETFS: Security[] = [
  { ticker: 'SPY', name: 'SPDR S&P 500 ETF Trust', sector: 'ETF - Broad Market' },
  { ticker: 'QQQ', name: 'Invesco QQQ Trust', sector: 'ETF - Technology' },
  ...
  { ticker: 'XLF', name: 'Financial Select Sector SPDR Fund', sector: 'ETF - Financials' },
  { ticker: 'XLK', name: 'Technology Select Sector SPDR Fund', sector: 'ETF - Technology' },
  { ticker: 'XLE', name: 'Energy Select Sector SPDR Fund', sector: 'ETF - Energy' },
  { ticker: 'XLV', name: 'Health Care Select Sector SPDR Fund', sector: 'ETF - Health Care' },
  { ticker: 'XLI', name: 'Industrial Select Sector SPDR Fund', sector: 'ETF - Industrials' },
  { ticker: 'XLP', name: 'Consumer Staples Select Sector SPDR Fund', sector: 'ETF - Consumer Staples' },
  { ticker: 'XLY', name: 'Consumer Discretionary Select Sector SPDR Fund', sector: 'ETF - Consumer Discretionary' },
  { ticker: 'XLU', name: 'Utilities Select Sector SPDR Fund', sector: 'ETF - Utilities' },
  { ticker: 'XLB', name: 'Materials Select Sector SPDR Fund', sector: 'ETF - Materials' },
  { ticker: 'XLRE', name: 'Real Estate Select Sector SPDR Fund', sector: 'ETF - Real Estate' },
  { ticker: 'XLC', name: 'Communication Services Select Sector SPDR Fund', sector: 'ETF - Communication Services' },
  { ticker: 'GLD', name: 'SPDR Gold Shares', sector: 'ETF - Commodities' },
  { ticker: 'SLV', name: 'iShares Silver Trust', sector: 'ETF - Commodities' },
  { ticker: 'TLT', name: 'iShares 20+ Year Treasury Bond ETF', sector: 'ETF - Bonds' },
  { ticker: 'AGG', name: 'iShares Core U.S. Aggregate Bond ETF', sector: 'ETF - Bonds' },
  { ticker: 'EEM', name: 'iShares MSCI Emerging Markets ETF', sector: 'ETF - International' },
  { ticker: 'EFA', name: 'iShares MSCI EAFE ETF', sector: 'ETF - International' },
  { ticker: 'VWO', name: 'Vanguard FTSE Emerging Markets ETF', sector: 'ETF - International' },
];

export const ALL_SECURITIES: Security[] = [...SP500_STOCKS, ...TOP_ETFS];
...
export function searchSecurities(query: string, limit: number = 10): Security[] {
...
export function getSecuritiesBySector(sector: string): Security[] {
  return ALL_SECURITIES.filter(s => s.sector === sector);
}

export function getSecurityByTicker(ticker: string): Security | undefined {
  return ALL_SECURITIES.find(s => s.ticker.toUpperCase() === ticker.toUpperCase());
}
